...
# Input field for API key at the start of the app
...
# Function to get OpenAI response using the ChatCompletion API
...
if api_key:  # Run agents only if API key is entered
